...
document.write("<link rel='stylesheet' href='"+Directorie+"FWJQ/src/FW_Grid/css/start/jquery-ui-1.7.2.custom.css' type='text/css' media='all' >");
document.write("<link rel='stylesheet' href='"+Directorie+"FWJQ/src/FW_Grid/css/ui.jqgrid.css' type='text/css' media='all'>");
document.write("<script src='"+Directorie+"FWJQ/lib/FW_System/Grid/grid.locale-en.js' type='text/javascript' charset='utf-8'></script>");
document.write("<script src='"+Directorie+"FWJQ/lib/FW_System/Grid/jquery.jqGrid.min.js' type='text/javascript' charset='utf-8'></script>");
document.write("<script src='"+Directorie+"FWJQ/lib/FW_System/Grid/jquery.jqGrid.fluid.js' type='text/javascript' charset='utf-8'></script>");
